...
namespace BigData
{
    public class Movie
    {
        ...
        {
            int actorsIntersect = this.Actors.Intersect(movie.Actors).Count();
            int actorsUnion = this.Actors.Union(movie.Actors).Count();

            int tagsIntersect = this.Tags.Intersect(movie.Tags).Count();
            int tagsUnion = this.Tags.Union(movie.Tags).Count();
